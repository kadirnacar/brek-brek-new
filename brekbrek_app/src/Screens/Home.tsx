...
export class HomeScreenComp extends Component<Props, any> {
  ...
  async componentDidMount() {
    ...
    //   id: new ObjectId(),
    //   Name: 'c1',
    //   Image: decode(imgData),
    // });

    // const c2 = await contact.save({
    //   id: new ObjectId(),
    //   Name: 'c2',
    //   Image: decode(imgData),
    // });

    // const c3 = await contact.save({
    //   id: new ObjectId(),
    //   Name: 'c3',
    //   Image: decode(imgData),
    // });
